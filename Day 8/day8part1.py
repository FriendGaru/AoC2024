...
class AntennaeMap:
    ...
    def find_antinodes(self, antenna_a_loc, antenna_b_loc, limit_bounds=True):
        ...
        if limit_bounds:
            if self.check_bounds(antinode_a):
                out_list.append(antinode_a)
            if self.check_bounds(antinode_b):
                out_list.append(antinode_b)
        else:
            out_list.append(antinode_a)
            out_list.append(antinode_b)
